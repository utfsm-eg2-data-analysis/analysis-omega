...
void AssignElectronVar_Data(TIdentificatorBasic* t, data_e& de, Int_t evnt, TString targetOption) {  
  de.Q2       = t->Q2();
  de.W        = t->W();
  de.Nu       = t->Nu();
  de.Xb       = t->Xb();
...
void AssignParticleVar_Data(TIdentificatorBasic* t, data_p& dp, Int_t row, Int_t evnt, TString targetOption) {
  // electron
  dp.Q2         = t->Q2();
  dp.W          = t->W();
  dp.Nu         = t->Nu();
