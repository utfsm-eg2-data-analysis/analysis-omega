#ifndef TIDENTIFICATORBASIC_H
#define TIDENTIFICATORBASIC_H
...
public:
  ...
  TIdentificatorBasic(TClasTool* CT = 0) : kEbeam(5.014), kMpi(0.139570), kMprt(0.938272), kMntr(0.939565), kGOOD(-1000.) {
    // Default constructor
    this->fCT = CT;    
  }
