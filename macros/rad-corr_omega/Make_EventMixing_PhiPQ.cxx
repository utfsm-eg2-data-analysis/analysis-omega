...
void Make_EventMixing_PhiPQ(TString targetOption = "D", Int_t fixParams = 0, TString StoreOption = "") {
  // 1) Normalize event-mixing bkg to match data on PhiPQ-dependent binning
  ...
  if (fixParams) {
    ...
    RootInputFile = new TFile(gProDir + "/gfx/rad-corr_omega/evnt-mixing_All_" + kinvarOption + "_data.root");
    // loop over bins
  ...
  TString CanvasName = "evnt-mixing_" + targetOption + "_" + kinvarOption + "_data";
