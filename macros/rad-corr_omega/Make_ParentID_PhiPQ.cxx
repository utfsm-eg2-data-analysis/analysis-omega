...
void Make_ParentID_PhiPQ(TString targetOption = "D", TString StoreOption = "") {
  // 1) Draw Invariant Mass Difference of generated omegas with parent-id cuts on PhiPQ-dependent binning
  // 2) Store histograms
