...
void Draw_RadCorrFactors(TString StoreOption = "") {
  // Draw the obtained Radiative Correction Factors obtained for "D" and "A", in PhiPQ binning
  ...
  Color_t targetColor[Ntargets] = {myGreen, myBlack};
  ...
  // set y-axis
  RadCorrGraph[0]->GetYaxis()->SetRangeUser(0.92, 1.08);
  ...
  legend->AddEntry(RadCorrGraph[0], "Liquid target (D)", "pl");
  legend->AddEntry(RadCorrGraph[1], "Solid targets (C, Fe, Pb)", "pl");
