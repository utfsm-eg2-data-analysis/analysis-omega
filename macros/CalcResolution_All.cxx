void CalcResolution_All() {
  ...
  ntuple_sim->Draw("(PhiLab - mc_PhiLab)>>HistPhiLab(100, -2, 2)", electronCuts && angularMatching && "P > 0. && P < 0.35", "goff");
  ...
  TCanvas *c = new TCanvas("all_res-phi", "c", 1000, 1000);
  gStyle->SetOptStat(1);
  ...
  ntuple_sim->Draw("(ThetaLab - mc_ThetaLab)>>HistThetaLab(100, -2, 2)", electronCuts && angularMatching && "P > 0. && P < 0.35", "goff");
  ...
  TCanvas *c1 = new TCanvas("all_res-theta", "c1", 1000, 1000);
  gStyle->SetOptStat(1);
